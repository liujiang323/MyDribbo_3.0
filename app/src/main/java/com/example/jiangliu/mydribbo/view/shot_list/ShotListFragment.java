...
import com.example.jiangliu.mydribbo.model.User;
import com.example.jiangliu.mydribbo.utils.ModelUtils;
import com.example.jiangliu.mydribbo.view.base.DribbbleTask;
import com.example.jiangliu.mydribbo.view.base.InfiniteAdapter;
import com.example.jiangliu.mydribbo.view.base.SpaceItemDecoration;
        ...
        if (requestCode == REQ_CODE_SHOT && resultCode == Activity.RESULT_OK) {
            ...
            for (Shot shot : adapter.getData()) {
                if (TextUtils.equals(shot.id, updatedShot.id)) {
                    ...
                    shot.bucketed = updatedShot.bucketed;
